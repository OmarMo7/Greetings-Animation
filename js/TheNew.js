...
$(function () {
  ...
  var TransitionEffects = (function () {
    ...
    // }
    function createMultiFlipSelect() {
      document.querySelector('head').innerHTML += '<link rel="stylesheet" type="text/css" href="css/style3.css" />'
      ...
      te_transition.classList.forEach(classs => {
        if (classs === "te-transition" || classs === "te-multiflip1" || classs === "te-multiflip2" || classs === "te-multiflip3") return;
        else te_transition.classList.remove(classs)
      })
      for (let i = 0; i < 7; i++) {
    ...
    function createRotateSelect() {
      document.querySelector('head').innerHTML += '<link rel="stylesheet" type="text/css" href="css/style2.css" />'
      // var link = document.createElement('link')
      // link.rel = "stylesheet"
      // link.type = "text/css"
      // link.href = "../css/style3.css"
      ...
      te_transition.classList.forEach(classs => {
        if (classs === "te-transition" || classs === "te-rotation1" || classs === "te-rotation2" || classs === "te-rotation3" || classs === "te-rotation4" || classs === "te-rotation5") return;
        else te_transition.classList.remove(classs)
      })
    ...
    init = function () {
      ...
      updateImages = function () {
        ...
        // (current_img === imagesCount - 14) ?
        // 	(last_img = imagesCount - 14, current_img = 0) :
